...
void *BFNetworkQuicAccept(int udpFileDescriptor, const struct sockaddr_storage *peer,
                          socklen_t peerLength, const BFNetworkSecurity *security) {
    (void)security;
    BFNetworkQuicHandle *handle = BFNetworkQuicHandleNew(udpFileDescriptor,
                                                        (const struct sockaddr *)peer, peerLength);
    if (!handle) {
        BFWarn("BFNetwork QUIC(ngtcp2): allocation failed");
        return NULL;
    }
...
void *BFNetworkQuicConnect(int udpFileDescriptor, const struct sockaddr *server,
                           socklen_t serverLength, const BFNetworkSecurity *security) {
    (void)udpFileDescriptor; (void)server; (void)serverLength; (void)security;
    BFWarn("BFNetwork QUIC: no implementation available at build time");
    return NULL;
}
void *BFNetworkQuicAccept(int udpFileDescriptor, const struct sockaddr_storage *peer,
                          socklen_t peerLength, const BFNetworkSecurity *security) {
    (void)udpFileDescriptor; (void)peer; (void)peerLength; (void)security;
    BFWarn("BFNetwork QUIC: no implementation available at build time");
    return NULL;
}
int BFNetworkQuicSend(void *handle, const void *buffer, int length) { (void)handle; (void)buffer; (void)length; return -1; }
int BFNetworkQuicRecv(void *handle, void *buffer, int length) { (void)handle; (void)buffer; (void)length; return -1; }
void BFNetworkQuicClose(void *handle) { (void)handle; }
#  endif
#endif
